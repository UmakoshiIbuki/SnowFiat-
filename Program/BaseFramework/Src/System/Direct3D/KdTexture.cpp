...
bool KdTexture::CreateRenderTarget(int w, int h, DXGI_FORMAT format, UINT arryCnt, const D3D11_SUBRESOURCE_DATA* fileData, UINT miscFlags)
{
	Release();
	D3D11_TEXTURE2D_DESC desc = {};
...
bool KdTexture::CreateDepthStencil(int w, int h, DXGI_FORMAT format, UINT arryCnt, const D3D11_SUBRESOURCE_DATA* fileData, UINT miscFlags)
{
	D3D11_TEXTURE2D_DESC desc = {};
	desc.Usage = D3D11_USAGE_DEFAULT;
	desc.Format = format;
