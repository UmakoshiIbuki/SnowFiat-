...
std::shared_ptr<KdModel> ResourceFactory:: GetModel(const std::string& filename)
{
	//filenameのモデルがあるか？
...
std::shared_ptr<KdTexture> ResourceFactory::GetTexture(const std::string& filename)
{
	//filenameのモデルがあるか？
...
std::shared_ptr<KdSoundEffect> ResourceFactory::GetSound(const std::string& filename)
{
	//filenameのモデルがあるか？
